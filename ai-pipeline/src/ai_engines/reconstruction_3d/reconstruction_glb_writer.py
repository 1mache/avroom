...
def write_output(
    ...
    """Package a generated GLB file for the caller.

    Args:
        glb_source: Path to the GLB file produced by the backend Space (lives
            inside ``gradio_client``'s temp cache; valid only for the
