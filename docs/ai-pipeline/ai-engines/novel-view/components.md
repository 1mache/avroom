...
- **`POST /images/novel-view`** — [`fastApi-app/api/novel_view.py`](../../../../fastApi-app/api/novel_view.py); resolves pose via `NovelViewRotationAdapter`, ensures GLB (`_ensure_object_glb`), then mesh-renders via the inference pool.
