...
> ```
>
> No code change is needed — the strategy resumes working on import. See the NOTE in `ai-pipeline/pyproject.toml` and [`docs/deployment/aws-runbook.md`](../../../deployment/aws-runbook.md).
...
Code: [`ai-pipeline/src/ai_engines/reconstruction_3d/`](../../../../ai-pipeline/src/ai_engines/reconstruction_3d/).
