...
| `test_trellis_reconstruction_smoke.py` | Cutout → `Reconstruction3DFacade` → GLB sanity (facade **defaults to TripoSR** unless you pass another strategy such as `TrellisReconstructionStrategy()`) |
