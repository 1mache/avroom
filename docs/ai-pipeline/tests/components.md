...
| `test_trellis_reconstruction_smoke.py` | Cutout → `Reconstruction3DFacade` → GLB sanity (facade **defaults to OpenLRM** unless you pass `TrellisReconstructionStrategy()`) |
