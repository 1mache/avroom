...
2. Run script via `python ai-pipeline/tests/<script>.py` from repo root or package virtualenv.
3. Inspect emitted PNG/GLB artifacts under `ai-pipeline/outputs/` or script-specific archives (`script_test_outputs/` subtree when runner copies results).
