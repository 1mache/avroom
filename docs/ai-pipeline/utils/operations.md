...
- **`shift_pixels`** downward bias — Helps masks cover occluding pixels lower in frame — inspect [`mask_refiner.py`](../../../ai-pipeline/src/utils/mask_refiner.py).
...
Saver resolves outputs folder relative to package installation — defaults effectively targeting `ai-pipeline/outputs/` layout.
