...
| **Domain Facade** | [`DepthMappingFacade`](../TestModules/src/ai_engines/depth/depth_mapping_facade.py), [`ImageSegmentationFacade`](../TestModules/src/ai_engines/segmentation/image_segmentation_facade.py), [`ImageInpaintingFacade`](../TestModules/src/ai_engines/inpainting/image_inpainting_facade.py), [`NovelViewFacade`](../TestModules/src/ai_engines/novel_view/novel_view_facade.py), [`Reconstruction3DFacade`](../TestModules/src/ai_engines/reconstruction_3d/reconstruction_3d_facade.py), [`CameraCalibrationFacade`](../TestModules/src/ai_engines/camera_calibration/camera_calibration_facade.py), [`ElevationEstimationFacade`](../TestModules/src/ai_engines/elevation_estimation/elevation_estimation_facade.py) | Each Facade owns exactly one Strategy and gives client code a stable surface that doesn't change when the strategy is swapped. |
...
- [`NovelViewStrategy.synthesize(image, *, elevation_deg, azimuth_deg, ...) -> ndarray`](../TestModules/src/ai_engines/novel_view/novel_view_strategy.py)
...
- [`CameraCalibrationStrategy.calibrate(image) -> CameraCalibrationResult`](../TestModules/src/ai_engines/camera_calibration/camera_calibration_strategy.py)
- [`ElevationEstimationStrategy.estimate(depth, mask, *, calibration) -> ElevationEstimationResult`](../TestModules/src/ai_engines/elevation_estimation/elevation_estimation_strategy.py)
