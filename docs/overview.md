...
There is **no** auth, no multi-user state, no 3D reconstruction in the live pipeline (see [ai-pipeline/3d-reconstruction-hunyuan.md](ai-pipeline/3d-reconstruction-hunyuan.md)), and no batch / async workflow yet.
