...
├── ai-pipeline/          - the avroom_object_removal Python package (depth/segmentation/inpainting/3D)
...
- `ai-pipeline/outputs/`, `fastApi-app/tmp/images/`, `ai-pipeline/depthMaps/` — runtime artifacts.
