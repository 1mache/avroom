...
start "AVRoom API" /D "%~dp0fastApi-app" cmd /k "call ..\.venv\Scripts\activate.bat && set INFERENCE_WORKERS=%INFERENCE_WORKERS% && uvicorn main:app --reload --reload-dir . --reload-dir ..\ai-pipeline"
